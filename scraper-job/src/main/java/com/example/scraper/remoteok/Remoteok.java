...
public class Remoteok extends Company implements Scraper<Job> {
    public Remoteok(Integer id, String url, String title, String logo, SiteType type) {
    ...
    public Collection<Job> mapJobsData(int jobLimit, String input, String type)
        ...
        for (int i = 0; i < jobLimit; i++) {
            ...
            String url = "https://remoteok.io" + doc.select("a.action-apply").get(i).attr("href");
