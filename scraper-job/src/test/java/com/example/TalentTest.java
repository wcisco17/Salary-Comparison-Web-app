...
public class TalentTest implements IScraper<Talent> {
    Talent website;
     ...
     */
    @Test
    @DisplayName("Should have the right url, name from DB - (Talent)")
    @Override
    public void shouldCheckWesbiteNotNull() throws IOException {
        ...
        Assertions.assertEquals(website.title, SiteType.TALENT);
    ...
    public void shouldCreateJob() throws IOException {
        Job job = new Job("Talent Test company name", "test job title", "$100,000 - $300,000", "logo.png",
