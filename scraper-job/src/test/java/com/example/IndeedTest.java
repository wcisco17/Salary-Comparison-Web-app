...
public class IndeedTest implements IScraper<Indeed> {
    Indeed website;
     ...
     */
    @Test
    @DisplayName("Should have the right url, name from DB - (Indeed)")
    @Override
    public void shouldCheckWesbiteNotNull() throws IOException {
        ...
        Assertions.assertEquals(website.title, SiteType.INDEED);
    ...
    public void shouldCreateJob() throws IOException {
        Job job = new Job("Indeed Test company name", "test job title", "$100,000 - $300,000", "logo.png",
